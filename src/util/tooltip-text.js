...
export const tooltipText = {
  ...
  advRoles: 'At least ^_k_5^ players are needed to use the ^_kw_Witness^ and ^_ka_Accomplice^ roles.<^_k_6^ or more are recommended.<For the most balanced game, use both roles (or neither).<>i>Using only the ^_kw_Witness^ may make the game harder for the ^_kk_Killer^.<>i>Using only the ^_ka_Accomplice^ may make things harder for the ^_kh_Hunters^ and the ^_kg_Ghost^.',
